...
// PaginatedResolutionNotesResponse represents a paginated response from the on-call alerts API.
...
// ListResolutionNotes fetches all on-call alerts for authorized organization.
//
// https://grafana.com/docs/oncall/latest/oncall-api-reference/alertgroups/
